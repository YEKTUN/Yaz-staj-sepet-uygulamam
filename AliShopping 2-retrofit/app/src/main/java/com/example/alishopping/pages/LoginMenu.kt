...
fun LoginMenu(
    ...
    val usernameLogin by viewModel.usernameLogin.observeAsState("")
        ...
        Card(
            ...
            Column(
                ...
                OutlinedTextField(
                    value = usernameLogin,
                    onValueChange = {
                        viewModel.setUsernameLogin(it)
                        Log.d("PLACEHOLDER", "Username field changed: $it")
                    },
                    ...
                    label = {
                        Text(
                            text = stringResource(id = R.string.username_login_label),
                            color = Color.Gray
                        )
                    },
                ...
                OutlinedTextField(
                    value = passwordLogin,
                    onValueChange = {
                        viewModel.setPasswordLogin(it)
                        Log.d("PLACEHOLDER", "password field changed: $it")
                    },
